...
public final class NebulaKeybinds {
    ...
    public static final KeyBinding CREATE_WAYPOINT = register("key.nebulaclient.create_waypoint", GLFW.GLFW_KEY_RIGHT_CONTROL);
    ...
    public static final KeyBinding WAYPOINT_MENU = register("key.nebulaclient.waypoint_menu", GLFW.GLFW_KEY_1);
